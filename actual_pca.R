...
cdat <- read_csv("county_data_take2 (1).csv")
...
help9 <- lm(fnd_per_person ~ out_coc5$scores[, 1:6], data = cocstuff4pca) # 5 components
help8 <- lm(homeless_rate ~ out_coc5$scores[, 1:6], data = cocstuff4pca) # 6 components
