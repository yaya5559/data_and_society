...
barplot(out_coc4$loadings[,1], main = "")
barplot(out_coc4$loadings[,2], main = "")
barplot(out_coc4$loadings[,3], main = "")
barplot(out_coc4$loadings[,4], main = "")


help4 <- lm(fnd_per_person ~ out_coc4$scores[, 1:3], data = cocstuff4pca)
